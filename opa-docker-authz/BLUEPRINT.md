...
# Blueprint: OPA Authorization for Docker Sandbox Access

> **Reverse-engineered.** This blueprint was reconstructed from a running
...
After implementing this blueprint, the host's Docker daemon listens on a TLS
...
2. Disable OPA plugin:
   ...
   ```
3. Restore daemon.json to pre-blueprint state:
   ```bash
...
- 2026-09-09 — Blueprint reverse-engineered from the `containers/claude/`
...
|---------|------------|--------------------------------|------------------------|
| 0.1.0   | 2026-09-09 | Initial blueprint (reverse-engineered) | all                   |

## Package Layout

```
docs/blueprints/opa-docker-authz/
